...
set_env filter_options "Low,Informational"
...
# Do NOT auto-run validation at source time — variables are populated
# by the calling pipeline script after this file is sourced.
# Call validate_zap_config explicitly after all vars are set if needed.
